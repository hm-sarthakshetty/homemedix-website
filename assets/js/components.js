/* ============================================================
   Home Medix — Shared Components (Nav + Footer)
...
(function () {
  ...
  const navHTML = `
    <nav class="site-nav" role="navigation" aria-label="Main navigation">
      <a class="nav-wordmark" href="${root}index.html" aria-label="Home Medix Home">
        <img src="${root}assets/images/HM.png" alt="Home Medix India" class="nav-logo">
      </a>
  ...
  const footerHTML = `
    <footer class="site-footer" role="contentinfo">
      <div class="footer-grid">
        <div class="footer-brand">
          <img src="${root}assets/images/HM.png" alt="Home Medix India" class="footer-logo">
        ...
        <div class="footer-col">
          ...
          <ul>
            ...
            <li><a href="https://www.youtube.com/@Home Medix" target="_blank" rel="noopener noreferrer">YouTube Channel</a></li>
          </ul>
        </div>
      ...
      <div class="footer-bottom">
        <span>© ${new Date().getFullYear()} Home Medix India Pvt. Ltd. &nbsp;·&nbsp; Bengaluru, Karnataka</span>
    ...
    <a class="whatsapp-fab"
       href="https://wa.me/919886012456?text=Hello%2C%20I%20am%20interested%20in%20Home Medix%20products."
